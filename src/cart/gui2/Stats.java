...
public class Stats {
	...
	public void updateStats(Set<Integer> objIds, int[] dimSupports, double[] standardDevs, int[] measures, int[] medAbsDevs) {
	...
	private class StatsTable extends AbstractTableModel {
        ...
        public void setCols(Object[] supports, Object[] devs, Object[] measures, Object[] medAbsDevs) {
        	data.clear();
        	columnNames.clear();
        	data.add(dims);
        	columnNames.add("Dimension");
